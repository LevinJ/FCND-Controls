...
class Answers:
    ...
    def angular_velocities(self, m, g, i_z, k_f, k_m, a_z, alpha, student_answer_omega_1, student_answer_omega_2) :
    ...
    def angular_acceleration(self, i_z, k_m, omega_1, omega_2, student_answer_alpha):
    ...
    def linear_acceleration(self,  m, g, k_f, omega_1, omega_2, student_answer_a_z ):
        f_1 = k_f * omega_1**2
        f_2 = k_f * omega_2**2
        f_g = m * g
        f_total = -f_1 - f_2 + f_g
    ...
    def vertical_acceleration(self, m, k_f, g ,phi, omega_1, omega_2, student_answer_a_z):
    ...
    def rolling_acceleration(self, k_f, i, l, omega_1, omega_2, student_answer_phi_dot_dot):
        f_1 = k_f * omega_1**2
        f_2 = k_f * omega_2**2
    ...
    def horizontal_acceleration(self, m, k_f, g, phi, omega_1, omega_2, student_answer_a_y ):
        f_1 = k_f * omega_1**2
        f_2 = k_f * omega_2**2
